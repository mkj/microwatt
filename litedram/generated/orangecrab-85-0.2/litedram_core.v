//--------------------------------------------------------------------------------
// Auto-generated by Migen (27dbf03) & LiteX (ab9f214a) on 2021-08-26 14:06:43
//--------------------------------------------------------------------------------
...
always @(posedge sys_clk) begin
	...
	if ((litedramcore_sequencer_counter == 6'd54)) begin
		litedramcore_cmd_payload_a <= 1'd0;
		litedramcore_cmd_payload_ba <= 1'd0;
		litedramcore_cmd_payload_cas <= 1'd0;
		litedramcore_cmd_payload_ras <= 1'd0;
	...
	if ((litedramcore_zqcs_executer_counter == 5'd18)) begin
		litedramcore_cmd_payload_a <= 1'd0;
		litedramcore_cmd_payload_ba <= 1'd0;
		litedramcore_cmd_payload_cas <= 1'd0;
		litedramcore_cmd_payload_ras <= 1'd0;
	...
	if (litedramcore_bankmachine4_trccon_valid) begin
		litedramcore_bankmachine4_trccon_count <= 2'd3;
		if (1'd0) begin
	...
	if (litedramcore_bankmachine5_trccon_valid) begin
		litedramcore_bankmachine5_trccon_count <= 2'd3;
		if (1'd0) begin
	...
	if (litedramcore_bankmachine6_trccon_valid) begin
		litedramcore_bankmachine6_trccon_count <= 2'd3;
		if (1'd0) begin
	...
	if (litedramcore_bankmachine7_trccon_valid) begin
		litedramcore_bankmachine7_trccon_count <= 2'd3;
		if (1'd0) begin
	...
	if (litedramcore_twtrcon_valid) begin
		litedramcore_twtrcon_count <= 3'd5;
		if (1'd0) begin
