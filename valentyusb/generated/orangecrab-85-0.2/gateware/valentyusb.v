//--------------------------------------------------------------------------------
// Auto-generated by Migen (--------) & LiteX (--------) on 2021-10-27 18:19:43
//--------------------------------------------------------------------------------
module valentyusb(
...
always @(*) begin
	...
	case (cdcusbphy_usbPacket)
		20'd590080: begin
			...
			cdcusbphy_response_addr <= 8'd224;
		end
		32'd2147483648: begin
			cdcusbphy_response_len <= 2'd2;
			cdcusbphy_response_addr <= 8'd222;
		end
		...
		32'd2147876879: begin
			...
			cdcusbphy_response_addr <= 8'd135;
		end
		...
		32'd2147877379: begin
			cdcusbphy_response_len <= 5'd30;
			cdcusbphy_response_addr <= 7'd105;
		end
		32'd2147937795: begin
			cdcusbphy_response_len <= 5'd18;
			cdcusbphy_response_addr <= 8'd164;
		end
...
always @(posedge usb_48_clk) begin
	...
	memdat <= storage[cdcusbphy_usb_core_rx_payloadFifo_wrport_adr];
end

always @(posedge usb_12_clk) begin
	memdat_1 <= storage[cdcusbphy_usb_core_rx_payloadFifo_rdport_adr];
end

assign cdcusbphy_usb_core_rx_payloadFifo_wrport_dat_r = memdat;
assign cdcusbphy_usb_core_rx_payloadFifo_rdport_dat_r = memdat_1;
...
always @(posedge usb_48_clk) begin
	...
	memdat_2 <= storage_1[cdcusbphy_usb_core_rx_flagsFifo_wrport_adr];
end

always @(posedge usb_12_clk) begin
	memdat_3 <= storage_1[cdcusbphy_usb_core_rx_flagsFifo_rdport_adr];
end

assign cdcusbphy_usb_core_rx_flagsFifo_wrport_dat_r = memdat_2;
assign cdcusbphy_usb_core_rx_flagsFifo_rdport_dat_r = memdat_3;
...
always @(posedge usb_12_clk) begin
	...
	memdat_4 <= storage_2[cdcusbphy_setuphandler_setuphandlerinner_wrport_adr];
end

always @(posedge usb_12_clk) begin
	if (cdcusbphy_setuphandler_setuphandlerinner_rdport_re)
		memdat_5 <= storage_2[cdcusbphy_setuphandler_setuphandlerinner_rdport_adr];
end

assign cdcusbphy_setuphandler_setuphandlerinner_wrport_dat_r = memdat_4;
assign cdcusbphy_setuphandler_setuphandlerinner_rdport_dat_r = memdat_5;
...
always @(posedge usb_12_clk) begin
	...
	memdat_6 <= storage_3[cdcusbphy_inhandler_syncfifobuffered_wrport_adr];
end

always @(posedge usb_12_clk) begin
	if (cdcusbphy_inhandler_syncfifobuffered_rdport_re)
		memdat_7 <= storage_3[cdcusbphy_inhandler_syncfifobuffered_rdport_adr];
end

assign cdcusbphy_inhandler_syncfifobuffered_wrport_dat_r = memdat_6;
assign cdcusbphy_inhandler_syncfifobuffered_rdport_dat_r = memdat_7;
...
always @(posedge usb_12_clk) begin
	...
	memdat_8 <= storage_4[cdcusbphy_outhandler_syncfifobuffered_wrport_adr];
end

always @(posedge usb_12_clk) begin
	if (cdcusbphy_outhandler_syncfifobuffered_rdport_re)
		memdat_9 <= storage_4[cdcusbphy_outhandler_syncfifobuffered_rdport_adr];
end

assign cdcusbphy_outhandler_syncfifobuffered_wrport_dat_r = memdat_8;
assign cdcusbphy_outhandler_syncfifobuffered_rdport_dat_r = memdat_9;

reg [7:0] out_buffer[0:230];
reg [7:0] memadr;
always @(posedge usb_12_clk) begin
	memadr <= cdcusbphy_adr;
end

assign cdcusbphy_dat_r = out_buffer[memadr];
...
always @(posedge sys_clk) begin
	...
	memdat_10 <= storage_5[asyncfifo0_wrport_adr];
end

always @(posedge usb_12_clk) begin
	memdat_11 <= storage_5[asyncfifo0_rdport_adr];
end

assign asyncfifo0_wrport_dat_r = memdat_10;
assign asyncfifo0_rdport_dat_r = memdat_11;
...
always @(posedge usb_12_clk) begin
	...
	memdat_12 <= storage_6[asyncfifo1_wrport_adr];
end

always @(posedge sys_clk) begin
	memdat_13 <= storage_6[asyncfifo1_rdport_adr];
end

assign asyncfifo1_wrport_dat_r = memdat_12;
assign asyncfifo1_rdport_dat_r = memdat_13;
